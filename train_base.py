...
from data_utils import Tokenizer4Bert, ISADataset1
...
def main():
    ...
    parser.add_argument('--model_name', default='bert_spcno', type=str)
    parser.add_argument('--dataset', default='entity1', type=str, help='twitter, restaurant, laptop')
    ...
    dataset_files = {
        ...
        'entity1': {
            'train': './datasets/semeval15/entity_train1.txt',
