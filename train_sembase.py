...
class Instructor:
    ...
    def _train(self, criterion, optimizer, train_data_loader, val_data_loader):
        ...
        for i_epoch in range(self.opt.num_epoch):
            ...
            logger.info('> val_acc: {:.4f}, val_f1: {:.4f}, ese: {:.4f}, ise: {:.4f}'.format(val_acc, val_f1, ese, ise))
...
def main():
    ...
    parser.add_argument('--dataset', default='laptop', type=str, help='laptop_xiarui, restaurant_xiarui')
