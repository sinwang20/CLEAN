...
def gen_eda(train_orig, output_file, alpha_rs, alpha_rd, alpha_ss=0.1, alpha_ri=0.1, aug_multi=1, stopwords=None):
    ...
    writer.close()
    print("generated augmented sentences with eda for " + train_orig + " to " + output_file + " with aug_multi=" + str(aug_multi))


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument("--input", default='../datasets/semeval14/Laptops_Train.xml.seg', type=str, help="input file of unaugmented data")
    parser.add_argument("--output", default='../datasets/semeval14/semlaptop_new_1.txt', type=str, help="output file of unaugmented data")
    parser.add_argument('--task', default='absa', type=str, help='isa, absa')
    parser.add_argument("--aug_multi", default=1, type=int, help="number of augmented sentences per original sentence per augmentation method, like 1, 2, 4, 8")
    ...
    parser.add_argument("--alpha_ss", default=0.1, type=float, help="percent of words in each sentence to be substituted")
